        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{(!empty($getEditProfile->profile_photo_path))  ? asset($getEditProfile->profile_photo_path):url('assets/no_image.jpg')}}" alt="Profile" class="rounded-circle">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{isset($getEditProfile->name) ? $getEditProfile->name : "NA"}}</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">{{ isset($getEditProfile->email ) ? $getEditProfile->email : "NA"}}</div>
                  </div>
                  <div class="row">
                  ...
                  <form method="post" action="{{route('admin.updateAdminProfile')}}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img id="output" src="{{(!empty($getEditProfile->profile_photo_path))  ? asset($getEditProfile->profile_photo_path):url('assets/no_image.jpg')}}" alt="Profile">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input  type="text" class="form-control" name="name"  value="{{$getEditProfile->name}}">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="{{$getEditProfile->email}}">
                      </div>
                    </div>
                    <div class="row mb-3 d-none">
                      <label for="about" class="col-md-4 col-lg-3 col-form-label">About</label>
                      <div class="col-md-8 col-lg-9">
                        <textarea name="about" class="form-control" id="about" nam style="height: 100px">Sunt est soluta temporibus accusantium neque nam maiores cumque temporibus. Tempora libero non est unde veniam est qui dolor. Ut sunt iure rerum quae quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea saepe at unde.</textarea>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="Linkedin" class="col-md-4 col-lg-3 col-form-label"> Profile</label>
