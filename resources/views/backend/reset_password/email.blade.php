...
<head>
    ...
    <title>@yield('title') E-mail link   </title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    @endif
                    <p class="text-center small">Please Enter your Registered Email-id</p>
                  </div>

              

                    <form class="row g-3 needs-validation" method="POST" action="{{route('send_admin_reset_link')}}">
                        @csrf        
                        <div class="col-12">
