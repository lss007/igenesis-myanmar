                ...
                <table class="table datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      {!!html_entity_decode(str_limit($value->description, $limit=100 ) )!!}
                        <br>
                    ...
                    <span class="text-success">  
                      ...
                      <td width="20%">
                        <img src="{{(isset($value->image))  ? asset('assets/ourteam/'.$value->image) :asset('no_image.jpg')}}"  alt="{{$value->title}}" width="100">
                      </td>
                      <td width="5%">
                        @if($value->status == '1')
